...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        $sql = 'INSERT INTO images(image_name, image_type, image_content, image_size, created_at, comment)
                VALUES (:image_name, :image_type, :image_content, :image_size, sysdate(), :comment)';
        $stmt = $pdo->prepare($sql);
...
<div class="title"><h1>MY Images</h1></div>
</div>
            ...
            <ul class="list-unstyled">
                <?php for($i = 0; $i < count($images); $i++): ?>
                    <li class="media mt-5">
                        ...
                        <h5><?= $images[$i]['created_at']; ?><br><?= $images[$i]['comment']; ?></h5>
